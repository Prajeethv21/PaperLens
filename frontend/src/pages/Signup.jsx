      ...
      >
        ...
        <div className="bg-gray-900 rounded-2xl shadow-2xl border border-yellow-700/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Join PaperLens today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
            ...
            <CustomButton type="submit" disabled={loading}>
              {loading ? 'C R E A T I N G . . .' : 'S I G N  U P'}
            </CustomButton>
          </form>
